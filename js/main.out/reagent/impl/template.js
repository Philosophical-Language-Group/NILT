...
var G__3159 = o;
(G__3159[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__3161__i = 0, G__3161__a = new Array(arguments.length -  0);
while (G__3161__i < G__3161__a.length) {G__3161__a[G__3161__i] = arguments[G__3161__i + 0]; ++G__3161__i;}
  args = new cljs.core.IndexedSeq(G__3161__a,0,null);
} 
...
var G__3163 = o;
(G__3163[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__3168 = props;
var G__3168__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__3168,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__3168);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__3168__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__3169){
var map__3170 = p__3169;
var map__3170__$1 = (((((!((map__3170 == null))))?(((((map__3170.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3170.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3170):map__3170);
var props = map__3170__$1;
var class$ = cljs.core.get.call(null,map__3170__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__3170,map__3170__$1,props,class$){
return (function (c){
...
});})(map__3170,map__3170__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__3172){
var map__3173 = p__3172;
var map__3173__$1 = (((((!((map__3173 == null))))?(((((map__3173.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__3173.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__3173):map__3173);
var on_write = cljs.core.get.call(null,map__3173__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__3173,map__3173__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__3173,map__3173__$1,on_write))
);
} else {
...
var G__3176 = jsprops;
(G__3176["defaultValue"] = value);

(G__3176["onChange"] = ((function (G__3176,v,value,on_change){
return (function (p1__3175_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__3175_SHARP_);
});})(G__3176,v,value,on_change))
);
...
var vec__3179 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__3179,(0),null);
var id = cljs.core.nth.call(null,vec__3179,(1),null);
var class$ = cljs.core.nth.call(null,vec__3179,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___3183 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___3183 == null)){
} else {
var key_3184 = temp__5461__auto___3183;
(jsprops["key"] = key_3184);
}
...
var temp__5461__auto___3185 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___3185 == null)){
} else {
var key_3186 = temp__5461__auto___3185;
reagent.impl.template.oset.call(null,jsprops,"key",key_3186);
}
...
var G__3187 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__3187["name"] = c);
...
var len__4641__auto___3192 = arguments.length;
var i__4642__auto___3193 = (0);
while(true){
if((i__4642__auto___3193 < len__4641__auto___3192)){
args__4647__auto__.push((arguments[i__4642__auto___3193]));

var G__3194 = (i__4642__auto___3193 + (1));
i__4642__auto___3193 = G__3194;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq3190){
var G__3191 = cljs.core.first.call(null,seq3190);
var seq3190__$1 = cljs.core.next.call(null,seq3190);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__3191,seq3190__$1);
});
...
break;
default:
var G__3197 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__3197;
continue;
...
var n__4518__auto___3199 = a.length;
var i_3200 = (0);
while(true){
if((i_3200 < n__4518__auto___3199)){
(a[i_3200] = reagent.impl.template.as_element.call(null,(a[i_3200])));
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___3202 = a.length;
var i_3203 = (0);
while(true){
if((i_3203 < n__4518__auto___3202)){
var val_3204 = (a[i_3203]);
if(((cljs.core.vector_QMARK_.call(null,val_3204)) && ((reagent.impl.template.key_from_vec.call(null,val_3204) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_3203] = reagent.impl.template.as_element.call(null,val_3204));

var G__3205 = (i_3203 + (1));
i_3203 = G__3205;
continue;
} else {
}
...
var ctx = ({});
var vec__3206 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__3206,(0),null);
var derefed = cljs.core.nth.call(null,vec__3206,(1),null);
...
var G__3209 = (cljs.core.count.call(null,argv) - first_child);
switch (G__3209) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__3209){
