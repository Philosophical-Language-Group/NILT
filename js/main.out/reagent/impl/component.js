...
if((i < len)){
var k = (ks[i]);
var G__3111 = cljs.core.assoc.call(null,m,cljs.core.keyword.call(null,k),(o[k]));
var G__3112 = (i + (1));
m = G__3111;
i = G__3112;
continue;
...
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__3114 = c;
var G__3114__$1 = (((G__3114 == null))?null:G__3114.prototype);
if((G__3114__$1 == null)){
return null;
} else {
return (G__3114__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_.call(null,c)) && ((!(((function (){var G__3116 = c;
var G__3116__$1 = (((G__3116 == null))?null:G__3116.prototype);
if((G__3116__$1 == null)){
return null;
} else {
return (G__3116__$1["render"]);
}
})() == null)))));
});
...
var _STAR_current_component_STAR__orig_val__3123 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__3124 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__3124;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__3123;
}});
...
return ((function (G__3125,G__3125__$1){
...
var c = this;
var G__3130_3132 = (c["cljsRatom"]);
if((G__3130_3132 == null)){
} else {
reagent.ratom.dispose_BANG_.call(null,G__3130_3132);
}
...
var renders_3134 = cljs.core.select_keys.call(null,fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_3135 = cljs.core.first.call(null,cljs.core.vals.call(null,renders_3134));
if((cljs.core.count.call(null,renders_3134) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count.call(null,renders_3134))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_.call(null,render_fun_3135)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.call(null,render_fun_3135))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__3133 = name;
switch (G__3133) {
case "":
...
var G__3137 = o;
(G__3137[cljs.core.name.call(null,k)] = v);
...
var name = (function (){var G__3138 = fiber;
var G__3138__$1 = (((G__3138 == null))?null:(G__3138["type"]));
if((G__3138__$1 == null)){
return null;
} else {
return (G__3138__$1["displayName"]);
}
})();
var parent = (function (){var G__3139 = fiber;
if((G__3139 == null)){
return null;
} else {
return (G__3139["return"]);
}
})();
var path = (function (){var G__3140 = parent;
var G__3140__$1 = (((G__3140 == null))?null:reagent.impl.component.fiber_component_path.call(null,G__3140));
if((G__3140__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3140__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var or__4047__auto__ = (function (){var G__3142 = c;
if((G__3142 == null)){
return null;
} else {
return (G__3142["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__3143._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4047__auto__ = (function (){var G__3145 = c;
if((G__3145 == null)){
return null;
} else {
return (G__3145["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var or__4047__auto____$1 = (function (){var G__3147 = c;
if((G__3147 == null)){
return null;
} else {
return G__3147._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4047__auto__ = (function (){var G__3149 = instance;
if((G__3149 == null)){
return null;
} else {
return (G__3149["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
} else {
var G__3150 = instance;
if((G__3150 == null)){
return null;
} else {
return G__3150._currentElement;
}
}
})();
var name = (function (){var G__3151 = elem;
var G__3151__$1 = (((G__3151 == null))?null:(G__3151["type"]));
if((G__3151__$1 == null)){
return null;
} else {
return (G__3151__$1["displayName"]);
}
})();
var owner = (function (){var or__4047__auto__ = (function (){var G__3153 = elem;
if((G__3153 == null)){
return null;
} else {
return (G__3153["_owner"]);
}
})();
if(cljs.core.truth_(or__4047__auto__)){
return or__4047__auto__;
...
return G__3154._owner;
}
}
})();
var path = (function (){var G__3155 = owner;
var G__3155__$1 = (((G__3155 == null))?null:reagent.impl.component.component_path.call(null,G__3155));
if((G__3155__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__3155__$1)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_.call(null,res)){
...
var G__3156 = c;
var G__3156__$1 = (((G__3156 == null))?null:G__3156.constructor);
if((G__3156__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name.call(null,G__3156__$1);
}
}
})();
