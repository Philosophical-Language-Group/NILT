...
return (function (p__1559){
var vec__1560 = p__1559;
var attr = cljs.core.nth.call(null,vec__1560,(0),null);
var v = cljs.core.nth.call(null,vec__1560,(1),null);
...
var len__4641__auto___1567 = arguments.length;
var i__4642__auto___1568 = (0);
while(true){
if((i__4642__auto___1568 < len__4641__auto___1567)){
args__4647__auto__.push((arguments[i__4642__auto___1568]));

var G__1569 = (i__4642__auto___1568 + (1));
i__4642__auto___1568 = G__1569;
continue;
} else {
}
break;
...
return adzerk.boot_reload.display.style.cljs$core$IFn$_invoke$arity$variadic(argseq__4648__auto__);
});
...
/** @this {Function} */
adzerk.boot_reload.display.style.cljs$lang$applyTo = (function (seq1566){
var self__4629__auto__ = this;
return self__4629__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq1566));
});
...
adzerk.boot_reload.display.exception_node = (function adzerk$boot_reload$display$exception_node(p__1570){
...
var data = map__1571__$1;
var message = cljs.core.get.call(null,map__1571__$1,new cljs.core.Keyword(null,"message","message",-406056002));
var line = cljs.core.get.call(null,map__1571__$1,new cljs.core.Keyword(null,"line","line",212345235));
var file = cljs.core.get.call(null,map__1571__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var G__1573 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),null,message);
goog.events.listen(G__1573,goog.events.EventType.CLICK,((function (G__1573,map__1571,map__1571__$1,data,message,line,file){
return (function (){
return adzerk.boot_reload.display.open_file.call(null,data);
});})(G__1573,map__1571,map__1571__$1,data,message,line,file))
);

return G__1573;
});
adzerk.boot_reload.display.warning_node = (function adzerk$boot_reload$display$warning_node(p__1574){
...
adzerk.boot_reload.display.construct_hud_node = (function adzerk$boot_reload$display$construct_hud_node(p__1578){
var map__1579 = p__1578;
var map__1579__$1 = (((((!((map__1579 == null))))?(((((map__1579.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__1579.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__1579):map__1579);
var messages = map__1579__$1;
var warnings = cljs.core.get.call(null,map__1579__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1579__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
var G__1581 = adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"pad","pad",-36734541),new cljs.core.Keyword(null,"flex","flex",-1425124628),new cljs.core.Keyword(null,"flex-c","flex-c",1898731114),(cljs.core.truth_(exception)?new cljs.core.Keyword(null,"bg-red","bg-red",-1645498040):((cljs.core.seq.call(null,warnings))?new cljs.core.Keyword(null,"bg-yellow","bg-yellow",-1293468429):new cljs.core.Keyword(null,"bg-clear","bg-clear",-673074101)
))));
goog.dom.append(G__1581,adzerk.boot_reload.display.mk_node.call(null,new cljs.core.Keyword(null,"div","div",1057191632),adzerk.boot_reload.display.style.call(null,new cljs.core.Keyword(null,"logo","logo",1237980263),new cljs.core.Keyword(null,"mr10","mr10",-144509621)),adzerk.boot_reload.display.logo_node.call(null,adzerk.boot_reload.display.cljs_logo)));

goog.dom.append(G__1581,(cljs.core.truth_(exception)?adzerk.boot_reload.display.exception_node.call(null,exception):((cljs.core.seq.call(null,warnings))?adzerk.boot_reload.display.warnings_node.call(null,warnings):adzerk.boot_reload.display.reloaded_node.call(null)
)));
...
adzerk.boot_reload.display.insert_container_BANG_ = (function adzerk$boot_reload$display$insert_container_BANG_(id,p__1582){
...
var messages = map__1583__$1;
var warnings = cljs.core.get.call(null,map__1583__$1,new cljs.core.Keyword(null,"warnings","warnings",-735437651));
var exception = cljs.core.get.call(null,map__1583__$1,new cljs.core.Keyword(null,"exception","exception",-335277064));
...
var show_BANG_ = ((function (hud,el,map__1583,map__1583__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,map__1583,map__1583__$1,messages,warnings,exception))
;
var no_prob_QMARK_ = ((cljs.core.not.call(null,exception)) && (cljs.core.not.call(null,cljs.core.seq.call(null,warnings))));
var hide_BANG_ = ((function (hud,el,show_BANG_,no_prob_QMARK_,map__1583,map__1583__$1,messages,warnings,exception){
return (function (){
...
});})(hud,el,show_BANG_,no_prob_QMARK_,map__1583,map__1583__$1,messages,warnings,exception))
;
...
}catch (e1585){if((e1585 instanceof Error)){
var __1586 = e1585;
} else {
throw e1585;
